...
export type ResponseWasReceived = Event<HttpApiV1EventTypes.RESPONSE_WAS_RECEIVED, {
...
export type ResponseCouldNotBeReceived = Event<HttpApiV1EventTypes.RESPONSE_COULD_NOT_BE_RECEIVED, { request: ApiV1Request }>
