...
export const InternalInputField: FC<FormElementFCProps<InputFieldState>> = (props) => {
...
export const ConnectedInternalInputField: ConnectedFormElementFC<InputFieldState> = connect(
