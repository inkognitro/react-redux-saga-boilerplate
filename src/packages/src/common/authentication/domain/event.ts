...
export type CurrentUserWasInitialized = Event<
    AuthEventTypes.CURRENT_USER_WAS_INITIALIZED,
...
export type AuthenticationWasRefreshed = Event<
    AuthEventTypes.AUTHENTICATION_WAS_REFRESHED,
    {
        authUser: AuthenticatedAuthUser;
