  ...
  render() {
    return (
          <ContentPage>
              ...
              <h3>Toasts</h3>
              <div>
<FunctionalLink onClick={() => this.props.onAddToast(ToastTypes.SUCCESS, this.props.toastContent)}>add a success toast message</FunctionalLink> (is being closed after 3 seconds)</div>
...
const mapDispatchToProps = (dispatch: Dispatch): DumbHomeCallbackProps => {
  return {
    ...
    onAddToast: (type: ToastTypes, content: string) =>
      dispatch(
        createShowMessage({
          content: content,
          toastType: type,
