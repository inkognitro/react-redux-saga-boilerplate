...
export function createStyledIcon(component: ComponentType): StyledComponent<ComponentType, any> {
    return styled(component)`
        ...
        &.style-info {color: ${(props: StyledComponentProps) => props.theme.colorInfo};}
        &.style-success {color: ${(props: StyledComponentProps) => props.theme.colorSuccess};}
        &.style-warning {color: ${(props: StyledComponentProps) => props.theme.colorWarning};}
        &.style-error {color: ${(props: StyledComponentProps) => props.theme.colorError};}
        &.style-interactive {color: ${(props: StyledComponentProps) => props.theme.colorInteractive};}
        &.style-secondary {color: ${(props: StyledComponentProps) => props.theme.colorSecondary};}
