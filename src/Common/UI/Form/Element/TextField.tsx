...
import {TextFieldState, Types} from "Common/Domain/Form/Element/TextField/Types";
...
const DumbTextField: FC<DumbTextFieldProps> = (props) => {
    const onChange = (props.data.readOnly ? undefined : (event: React.ChangeEvent<HTMLInputElement>) => {
