import {HttpRequest, HttpResponse, RequestHandlerEventTypes} from "Common/RequestHandling/Domain/Base/Http/Types";
import {take} from "@redux-saga/core/effects";
import {HttpRequestWasNotSent} from "Common/RequestHandling/Domain/Base/Http/Event/HttpRequestWasNotSent";
import {HttpSuccessResponseWasReceived} from "Common/RequestHandling/Domain/Base/Http/Event/HttpSuccessResponseWasReceived";
import {HttpErrorResponseWasReceived} from "Common/RequestHandling/Domain/Base/Http/Event/HttpErrorResponseWasReceived";
import {HttpRequestFailed} from "Common/RequestHandling/Domain/Base/Http/Event/HttpRequestFailed";
import {HttpRequestWasCancelled} from "Common/RequestHandling/Domain/Base/Http/Event/HttpRequestWasCancelled";
