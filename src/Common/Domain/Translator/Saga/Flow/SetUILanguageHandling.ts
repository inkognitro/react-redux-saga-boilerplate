import {
    LanguageIds,
    TranslationIdToTranslationMapping, TranslatorCommandTypes,
    TranslatorState,
...
export function createWatchSetUILanguageFlow(translatorStateSelector: TranslatorStateSelector): GeneratorFunction {
