import {ShowMessage, ShowMessageSettings} from "Common/Domain/Toaster/Command/ShowMessage";
...
export function* handleShowMessage(toasterStateSelector: ToasterStateSelector, command: ShowMessage): Generator {
    //@ts-ignore
