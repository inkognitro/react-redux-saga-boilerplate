...
export function createWatchRemoveMessageFlow(toasterStateSelector: ToasterStateSelector): () => Generator {
    return function* (): Generator {
        yield takeEvery(ToasterCommandTypes.REMOVE_MESSAGE, function* (command: RemoveMessage): Generator {
            // @ts-ignore
