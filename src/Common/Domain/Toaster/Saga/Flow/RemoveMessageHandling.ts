import {ToasterCommandTypes, ToasterState, ToasterStateSelector} from "Common/Domain/Toaster/Types";
...
export function createWatchRemoveMessageFlow(toasterStateSelector: ToasterStateSelector): GeneratorFunction {
