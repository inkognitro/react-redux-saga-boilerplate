import {Message, Toast, ToasterCommandTypes, ToasterState, ToasterStateSelector} from "Common/Domain/Toaster/Types";
...
import {MoveMessagesFromPipelineToToasts} from "Common/Domain/Toaster/Command/MoveMessagesFromPipelineToToasts";

export function createWatchMoveMessagesFromPipelineToToastsFlow(
