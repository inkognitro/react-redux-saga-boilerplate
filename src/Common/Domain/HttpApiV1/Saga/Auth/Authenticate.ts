import { apiV1BaseUrl } from "Common/Domain/HttpApiV1/HttpApiV1";
import { ApiV1ReadResponse } from "Common/Domain/HttpApiV1/Types";
import { User } from "Common/Domain/Model/User";
import { call, put } from "redux-saga/effects";
import { createPostRequest } from "Common/Domain/HttpFoundation/Command/RequestFactory";
import { Request } from "Common/Domain/HttpFoundation/Types";
import { createSendHttpRequest } from "Common/Domain/HttpApiV1/Command/SendHttpRequest";
import {
    receiveHttpResponse,
} from "Common/Domain/HttpFoundation/Saga/Callables/HttpResponseReceiving";
