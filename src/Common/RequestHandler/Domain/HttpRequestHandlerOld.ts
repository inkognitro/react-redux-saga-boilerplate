import {HttpRequest, HttpRequestResponse, SuccessHttpRequestResponse} from "Common/RequestHandler/Domain/Types";
...
import {createHttpRequestWasFinished} from "Common/RequestHandler/Domain/Event/HttpRequestWasFinished";

export interface HttpRequestDispatcher {
    executeRequest(settings: RequestExecutionSettings): void
}

export class HttpRequestHandlerOld {
