...
import { getCommonToastIdByType } from "Packages/Common/Domain/Toaster/Query/CommonToastIdByTypeQuery";
import {
    delay, fork, put, select, spawn,
} from "redux-saga/effects";
import { createRemoveMessage } from "Packages/Common/Domain/Toaster/Command/RemoveMessage";
import { findToastById } from "Packages/Common/Domain/Toaster/Query/ToastQuery";
import { createToastWasAdded } from "Packages/Common/Domain/Toaster/Event/ToastWasAdded";
import { createToastIntroAnimationWasFinished } from "Packages/Common/Domain/Toaster/Event/ToastIntroAnimationWasFinished";
import { createMessagesWereAddedToToast } from "Packages/Common/Domain/Toaster/Event/MessagesWereAddedToToast";
import { createMessageIntroAnimationsWereFinished } from "Packages/Common/Domain/Toaster/Event/MessageIntroAnimationsWereFinished";
