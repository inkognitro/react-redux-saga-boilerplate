import { HttpRequestWasSent } from "Packages/Common/Domain/HttpFoundation/Event/HttpRequestWasSent";
import { HttpErrorResponseWasReceived } from "Packages/Common/Domain/HttpFoundation/Event/HttpErrorResponseWasReceived";
import { HttpRequestFailed } from "Packages/Common/Domain/HttpFoundation/Event/HttpRequestFailed";
import { HttpRequestWasCancelled } from "Packages/Common/Domain/HttpFoundation/Event/HttpRequestWasCancelled";
import { HttpRequestWasNotSent } from "Packages/Common/Domain/HttpFoundation/Event/HttpRequestWasNotSent";
import { HttpSuccessResponseWasReceived } from "Packages/Common/Domain/HttpFoundation/Event/HttpSuccessResponseWasReceived";
